      ...
      <div className=" mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-2xl md:text-3xl font-meduim mb-8 bg-white py-4 jakarta">
            We've handpicked Jewels according to your choices
          </h2>
          
          {/* Action Buttons */}
          <div className="flex gap-4 justify-end max-w-7xl">
            <button onClick={()=>router.push("/try-on")} className="bg-[#BA9456] text-xl hover:bg-[#af894b] text-white px-8 py-3 rounded-lg font-medium transition-colors">
              Try on me
            </button> 
